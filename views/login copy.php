...
<body class="cover">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($resultado->num_rows == 1){
            ...
            echo "Número de filas devueltas opcion 1: " . $resultado->num_rows;
            print_r($usuario);
            ...
            if(password_verify($contrasena, $usuario['contraseña'])){
                ...
                if($resultado->num_rows == 1){ 
                    ...
                    echo "Número de filas devueltas opcion 2: " . $resultado->num_rows;
                    echo 'aqui deberias estar';
            ...
            echo "Número de filas devueltas opcion 3: " . $resultado->num_rows;
        //    var_dump(password_verify($contrasena, $usuario['contraseña']));
        //     echo 'que haces aqui';
