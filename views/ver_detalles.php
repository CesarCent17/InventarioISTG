      ...
      <form class="mdl-grid" action="../php/save_test.php" method="post" style="max-width: 800px; margin: 0 auto;">
          ...
          <div class="mdl-cell mdl-cell--12-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled">
              <input class="mdl-textfield__input" type="text" id="nombre" name="nombre" required value="PRUEBA" readonly>
          ...
          <div class="mdl-cell mdl-cell--12-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled" >
              <input class="mdl-textfield__input" type="text" id="descripcion" name="descripcion" required value="PRUEBA" readonly>
          ...
          <div class="mdl-cell mdl-cell--6-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled">
              <input class="mdl-textfield__input" type="number" id="numero_de_acta" name="numero_de_acta" value="5" readonly>
          ...
          <div class="mdl-cell mdl-cell--6-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
              <input class="mdl-textfield__input" type="number" id="anio" name="anio" value="2020" readonly>
          ...
          <div class="mdl-cell mdl-cell--6-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled">
              <input class="mdl-textfield__input" type="text" id="campus" name="campus" value="CAMPUS PRUEBA" readonly>
        ...
        <div class="mdl-cell mdl-cell--6-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled">
              <input class="mdl-textfield__input" type="text" id="area_de_ubicacion" name="area_de_ubicacion" value="BIBLIOTECA" readonly>
        ...
        <div class="mdl-cell mdl-cell--12-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
              <input class="mdl-textfield__input" type="text" id="codigoISTG" name="codigoISTG" required value="PRUEBA" readonly>
          ...
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label  div-codigoSENESCYT/SECAP/COLEGIO" id=divCodigo>
              <input class="mdl-textfield__input" type="text" id="codigoSENESCYT/SECAP/COLEGIO" name="codigoSENESCYT/SECAP/COLEGIO" value="PRUEBA" readonly>
          ...
          <div class="mdl-cell mdl-cell--6-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled">
              <input class="mdl-textfield__input" type="text" id="origen_del_bien" name="origen_del_bien" value="ORIGEN PRUEBA" readonly>
          ...
          <div class="mdl-cell mdl-cell--6-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled">
              <input class="mdl-textfield__input" type="text" id="custodio" name="custodio" value="CUSTODIO PRUEBA" readonly>
          ...
          <div class="mdl-cell mdl-cell--6-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled">
              <input class="mdl-textfield__input" type="text" id="proceso_de_adquisicion" name="proceso_de_adquisicion" value="PROCESO PRUEBA" readonly>
          ...
          <div class="mdl-cell mdl-cell--6-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled">
              <input class="mdl-textfield__input" type="text" id="estado_de_uso" name="estado_de_uso" value="ESTADO PRUEBA" readonly>
          ...
          <div class="mdl-cell mdl-cell--6-col">
            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label is-upgraded is-disabled">
              <input class="mdl-textfield__input" type="text" id="estado_fisico" name="estado_fisico" value="ESTADO PRUEBA" readonly>
